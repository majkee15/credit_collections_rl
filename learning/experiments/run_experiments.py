...
from learning.experiments.configs import ConfigDQN, ConfigSplineApprox, ConfigSplineNaive
...
if __name__ == '__main__':
    ...
    names = ['DQN', 'SPLINE', 'MONOSPLINE']
    experiment_types = ['dqn', 'bspline', 'bspline']
    configs = [ConfigDQN(), ConfigSplineNaive(), ConfigSplineApprox()]
